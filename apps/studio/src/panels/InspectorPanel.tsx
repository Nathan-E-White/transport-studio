        ...
        {!entity ? (
            ...
            <>
              ...
              <PropertySection title="Transform">
                <Property label="Position" value={formatVec(entity.transform.position)} />
                <Property label="Rotation" value={formatVec(entity.transform.rotation)} />
                <Property label="Scale" value={formatVec(entity.transform.scale)} />
              </PropertySection>
...
function formatVec(vec: { readonly x: number; readonly y: number; readonly z: number }) {
